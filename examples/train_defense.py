...
def play_a_round(env, map_size, handles, models, print_every, train=True, render=False, eps=None):
    ...
    env.add_walls(method="random", n=100)
    env.add_agents(handles[0], method="random", n=100)  # killer
    env.add_agents(handles[1], method="random", n=100)  # guard
    env.add_agents(handles[2], method="random", n=1)    # king
...
if __name__ == "__main__":
    ...
    # init the game
    env = magent.GridWorld("defense", map_size=args.map_size)
